...
if __name__ == "__main__":
    ...
    parser.add_argument("--interval_max", nargs="?", default=5)
    parser.add_argument("--total_time_min", nargs="?", default=1)
    parser.add_argument("--total_time_max", nargs="?", default=5)
    parser.add_argument("--total_time_num_steps", nargs="?", default=9)
