...
if __name__ == "__main__":
    ...
    plt.step(np.linspace(0, total_time, num_of_intervals), theta_waveforms_df["theta_x"], linewidth=2 * 1.15)
    ...
    plt.figure(figsize=(15, 9), linewidth=2 * 1.15)
    plt.step(np.linspace(0, total_time, num_of_intervals), theta_waveforms_df["theta_y"], linewidth=2 * 1.15)
    plt.title(title_str, fontsize=20 * 1.15, pad=10)
    plt.xlabel("$\Omega t$", fontsize=20 * 1.15)
