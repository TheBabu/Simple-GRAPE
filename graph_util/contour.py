...
if __name__ == "__main__":
    ...
    min_init_seed_cost_data_df = cost_data_df.groupby(["num_of_intervals", "total_time", "target_state_seed"], as_index=False)["final_cost"].max()
    ...
    plt.title(f"Fidelity vs. Total Time \& Number of Time Intervals (Spin: {spin})", fontsize=20 * 1.15, pad=10)
